...
- [Naive Bayes Classifier: Learning Naive Bayes with Python](https://www.edureka.co/blog/naive-bayes-tutorial/)
- [ML | Naive Bayes Scratch Implementation using Python](https://www.geeksforgeeks.org/ml-naive-bayes-scratch-implementation-using-python/)
